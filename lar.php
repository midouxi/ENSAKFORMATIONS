...
<html lang="en">
<head>
<title>ENSA Khouribga - License administration réseaux</title>
<meta charset="utf-8">
...
<body>
  ...
  <div class="container_12 mar-left1 tol sky"> 
        <article class="grid_13 last-col">
          <h1 class="hello_box">License universitaire en sciences appliquées Administration Réseaux</h1>
        </article>
        <article class="grid_5">
            ...
            <div class="sky-tabs sky-tabs-pos-top-justify sky-tabs-anim-slide-down-left sky-tabs-response-to-icons">
				...
				<ul>
					<li class="sky-tab-content-1">  
              		...
              		<li class="sky-tab-content-2"> <ul>
                          <li><strong>M6 :</strong>Administration des réseaux</li>
          ...
          <article class="grid_5">
            ...
            <div class="linnee">
              <ul>
                <li><strong>Domaine : </strong> Informatique et réseaux</li>
          ...
          <article class="grid_5">
            ...
            <div id="accordion">
              ...
              <div> <ul> <li><strong>avant le 15/09/2014 :</strong> dépot du dossier de candidature</li>
                         <li><strong>Du 22 au 30/09/2014 : </strong> Entretien de séléction</li>
                    </ul>
                </div>
              <h3>Les frais</h3>
              <div> 
                    <ul> <li><strong>frais de formation :</strong> 30 000 Dhs</li>
          ...
          <article class="grid_10 lhata">
            <div style="text-align:center"> <img src="images/sponsor-lar.jpg"> </div>
          </article>
</div>
<br>
